...
```bash
bash .Codex/skills/generer-fem-fingre/scripts/fetch_pack_id.sh
```
...
Kjør:
```bash
bash .Codex/skills/generer-fem-fingre/scripts/fetch_existing.sh > /tmp/klink_femfingre_existing.json
```
...
Kjør:
```bash
bash .Codex/skills/generer-fem-fingre/scripts/check_duplicates.sh \
...
Kjør:
```bash
python3 .Codex/skills/generer-fem-fingre/scripts/build_insert_migration.py \
