...
```bash
bash .Codex/skills/generer-festsporsmal/scripts/check_duplicates.sh --check-table
```
...
- Kjør schema-migrasjonen først:
  ...
  cp .Codex/skills/generer-festsporsmal/sql/schema.sql supabase/migrations/XXXXX_festsporsmal_schema.sql
...
Kjør:
```bash
bash .Codex/skills/generer-festsporsmal/scripts/check_duplicates.sh --fetch-existing
```
...
Kjør:
```bash
bash .Codex/skills/generer-festsporsmal/scripts/check_duplicates.sh \
...
Kjør:
```bash
python3 .Codex/skills/generer-festsporsmal/scripts/build_insert_migration.py \
