...
export function PackCard({ pack, selected, onToggle, cardCount }: PackCardProps) {
  ...
  return (
    <>
      <div
        className={cn(
          'relative w-full rounded-2xl p-4 text-left transition-all overflow-hidden',
      ...
      >
        <button
          ...
          className="absolute inset-0 rounded-2xl active:scale-95"
        />
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <button
                ...
                className="pointer-events-auto w-11 h-11 -m-2 rounded-full bg-white/20 hover:bg-white/35 flex items-center justify-center transition"
              >
